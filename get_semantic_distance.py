...
input_path_orfs = "./genome_embeddings_ecoli/" #CNN results containing first chain of every protein only
genome = "ecoli_s88"
...
for microcin in microcin_list:
    ...
    output_path = "./distance_csvs/distances_" + microcin_name + "_vs_" + genome + ".csv"
